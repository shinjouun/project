...
(
	...
	usmscheck varchar(5) default 'N' comment 'sms동의'
);
...
(
	...
	cpno int comment '챔피언번호',
	rnote text comment '평가내용',
	rdate DATETIME default now() comment '작성날짜',
...
insert into user(uid, upw, uname, unickname, upnum, umail, uadmin)
values('admin', md5('admin'), '관리자', '관리자', '010-5555-1234', 'admin@naver.com', 'A')