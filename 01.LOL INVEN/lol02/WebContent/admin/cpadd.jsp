		...
		<form id="cpadd" name="cpadd" method="post" action="../admin/cpaddok.jsp" enctype="multipart/form-data">
			<table class="cpaddlist"  border="1" align="center" width="500px">
				...
				<tr>
					...
					<%
					//[1]
						String pos[] = { "001:전사", "002:마법사", "003:원거리"}; //포지션 2번
						for(int i=0; i < pos.length; i++) //포지션 3번
						{
							String ary[] = pos[i].split(":"); //포지션4번
							if(i == pos.length-1)
							{
								%>
								<input type="checkbox" id="position" name="position" value="<%= pos[i] %>" >&nbsp;&nbsp;<%=ary[1] %> <!--  포지션1번  -->
								<%
							}
							else
							{
